            ...
            <div className="max-w-6xl mx-auto px-4">
                ...
                <div className="mt-6 flex items-center justify-center gap-2">
                    {Array.from({ length: totalGroups }).map((_, idx) => (
                        <span
                            key={idx}
                            className={`w-2.5 h-2.5 rounded-full ${idx === activeGroup
                                    ? "bg-[#275A3A]"
...
export default function ProductDetailPage() {
                        ...
                        <div className="mt-5 flex gap-4">
                            {product.thumbnails.map((thumb, idx) => (
                                <button
                                    ...
                                    className={`rounded-2xl overflow-hidden border transition ${activeIndex === idx
                                            ? "border-[#3A643B]"
                        ...
                        <div className="flex flex-wrap gap-3">
                            {product.sizes.map((size) => (
                                <button
                                    ...
                                    className={`px-5 py-2 rounded-full text-sm border transition ${selectedSize === size
  ...
  <div className="max-w-6xl mx-auto px-4 lg:grid lg:grid-cols-2">
    {/* This div moves the content into the RIGHT column on lg+ screens */}
    <div className="lg:col-start-2">
      ...
      {/* cards – your routing stays exactly the same */}
